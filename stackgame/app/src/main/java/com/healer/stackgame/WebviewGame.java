...
public class WebviewGame extends WebView {
    ...
    protected WebviewManager manager;
    ...
    public WebviewGame(Context context) {
        super(context);
        init(context);
    }

    public void setManager(WebviewManager manager) {
        this.manager = manager;
    }

    public WebviewGame(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public WebviewGame(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, WebviewGame.PACKAGE_NAME_DOWNLOAD_MANAGER);
